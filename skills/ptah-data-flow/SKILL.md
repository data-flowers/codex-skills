...
- Stage 2: canonicalize, deduplicate, preserve identifiers, and diagnose missingness.
- Stage 3: design and assign one defensible taxonomy after inspecting the whole dataset.
